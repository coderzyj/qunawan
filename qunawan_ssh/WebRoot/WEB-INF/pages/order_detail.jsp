	...
	<div class="body_bg" style="padding-bottom: 30px;">
		<div class="base">
			...
			<div class="navigation">
				<span class="font_g9"> <a href="index">我的去哪玩</a> > <a href="order!showMyorder">我的订单</a>
					...
					<div class="view-box">
						...
						<div class="order_list-box">
							<table class="r-table">
								...
								<tbody>
									<tr>
										<td>【${orderDetailForm.order.content}】</td>
										<td>${orderDetailForm.order.start_time}</td>
										<td>${orderDetailForm.order.price/orderDetailForm.order.person_num}</td>
										<td>${orderDetailForm.order.person_num}</td>
										<td>${orderDetailForm.order.price}</td>
									</tr>
								</tbody>
							</table>
							<!--赠品开始 -->
							...
							<p class="price-sum">
								<b>订单结算总额：</b>
								<dfn>
									¥<i class="f24">${orderDetailForm.order.price}</i>
								</dfn>
							</p>
						</div>
						<!-- <<订单列表 -->
