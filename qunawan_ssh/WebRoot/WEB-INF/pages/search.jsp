					...
					<div class="recommend">
						<div class="detail"> 
							<a class="detail_img" href="tripDetail.jhtml?id=${trip.id}&type=init">
								...
								<c:if test="${fn:trim(trip.sequence.value) == '自驾游' }">
									<span class="detail_tag detail_tag_blue">自驾游</span>
								</c:if>
								<c:if test="${fn:trim(trip.sequence.value) == '国内游' }">
									<span class="detail_tag detail_tag_green">国内游</span>
								</c:if>
								<c:if test="${fn:trim(trip.sequence.value) == '出境游' }">
							...
							<div class="price">
								...
								<p class="good_comment"><span>${trip.goodRate }%</span>好评率</p>
							</div>
							<div class="detail">
								<div class="detail_list">
									<p class="detail_title">
										<span class="title_left">${trip.city.name }出发 |</span>
									...
									<dl class="detail_text theme_text">
										...
										<dd>
											<p>
												<c:forEach items="${trip.themeontrips}" var="tot" varStatus="index">
													${tot.theme.name }
									...
									<dl class="detail_text theme_text">
										...
										<dd>
											<p>
												<c:forEach items="${trip.placeontrips}" var="pot" varStatus="index">
													${pot.place.name }
													<c:if test="${!index.last }">,</c:if>
												</c:forEach>
											</p>
